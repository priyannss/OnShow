...
const MovieDetails = () => {
  ...
  const handleFavourite = async () => {
    try {
      if(!user) {
        return toast.error("Please login to add it into your favourite")
      }
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='flex justify-center mt-16'>
        <button onClick={() => {navigate("/movies"); scrollTo(0, 0)}} className='px-6 py-3 text-sm sm:text-base bg-primary hover:bg-primary-dull rounded-full font-medium text-white shadow-md cursor-pointer'>Show More</button>
      </div>
